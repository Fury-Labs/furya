...
// RunForkLogic executes height-gated on-chain fork logic for the Furya v3
// upgrade.
func RunForkLogic(ctx sdk.Context, keepers *keepers.AppKeepers) {
	ctx.Logger().Info("Applying Furya v3 upgrade." +
...
func FixMinDepositDenom(ctx sdk.Context, gov *govkeeper.Keeper) {
	...
	params.MinDeposit = sdk.NewCoins(sdk.NewCoin("ufury", osmomath.NewInt(500000000)))
