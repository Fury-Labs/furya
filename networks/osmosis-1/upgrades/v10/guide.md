...
You will need to be running go1.18 for this version of Furya. You can check if you are running go1.18 with the following command:
...
```{.sh}
mkdir -p ~/.furyad/cosmovisor/upgrades/v9/bin
cd $HOME/furya
git pull
git checkout v10.0.0
make build
cp build/furyad ~/.furyad/cosmovisor/upgrades/v9/bin
```
...
If you need more help, please go to <https://docs.furya.zone> or join our discord at <https://discord.gg/pAxjcFnAFH>.
