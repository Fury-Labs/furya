...
def estimate_single_position_within_one_tick_ofz():
    ...
    when swapping token one for token zero (ofz).
     ...
     go test -timeout 30s -v -run TestKeeperTestSuite/TestCalcAndSwapOutAmtGivenIn/fee_1 github.com/fury-labs/furya/v20/x/concentrated-liquidity
    """
...
def estimate_two_positions_within_one_tick_zfo():
    ...
    when swapping token zero for one (zfo).
     ...
     go test -timeout 30s -v -run TestKeeperTestSuite/TestCalcAndSwapOutAmtGivenIn/fee_2 github.com/fury-labs/furya/v20/x/concentrated-liquidity
    """
...
def estimate_two_consecutive_positions_zfo(spread_factor: str, expected_token_out_total: str, expected_spread_rewards_growth_per_share_total: str):
    ...
    when swapping token zero for one (zfo).
     ...
     go test -timeout 30s -v -run TestKeeperTestSuite/TestCalcAndSwapOutAmtGivenIn/fee_3 github.com/fury-labs/furya/v20/x/concentrated-liquidity
    """
...
def estimate_overlapping_price_range_ofz_test(spread_factor: str, expected_token_out_total: str, expected_spread_rewards_growth_per_share_total: str):
    ...
    when swapping token one for token zero (ofz).
     ...
     go test -timeout 30s -v -run TestKeeperTestSuite/TestCalcAndSwapOutAmtGivenIn/fee_4 github.com/fury-labs/furya/v20/x/concentrated-liquidity
    """
...
def estimate_overlapping_price_range_zfo_test(token_in_initial: str, spread_factor: str, expected_token_out_total: str, expected_spread_rewards_growth_per_share_total: str):
    ...
    when swapping token zero for one (zfo) and not consuming full liquidity of the second position.
     ...
     go test -timeout 30s -v -run TestKeeperTestSuite/TestCalcAndSwapOutAmtGivenIn/fee_5 github.com/fury-labs/furya/v20/x/concentrated-liquidity
    """
...
def estimate_consecutive_positions_gap_ofz_test():
    ...
    when swapping token one for zero (ofz).
     ...
     go test -timeout 30s -v -run TestKeeperTestSuite/TestCalcAndSwapOutAmtGivenIn/fee_6 github.com/fury-labs/furya/v20/x/concentrated-liquidity
    """
...
def estimate_slippage_protection_zfo_test():
    ...
    when swapping token zero for one (zfo).
     ...
     go test -timeout 30s -v -run TestKeeperTestSuite/TestCalcAndSwapOutAmtGivenIn/fee_7 github.com/fury-labs/furya/v20/x/concentrated-liquidity
    """
