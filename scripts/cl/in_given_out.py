...
def estimate_single_position_within_one_tick_ofz_in_given_out():
    ...
    when swapping token one for token zero (ofz).
     ...
     go test -timeout 30s -v -run TestKeeperTestSuite/TestCalcAndSwapInAmtGivenOut/fee_1 github.com/fury-labs/furya/v20/x/concentrated-liquidity
    """
...
def estimate_two_positions_within_one_tick_zfo_in_given_out():
    ...
    when swapping token zero for one (zfo).
     ...
     go test -timeout 30s -v -run TestKeeperTestSuite/TestCalcAndSwapInAmtGivenOut/fee_2 github.com/fury-labs/furya/v20/x/concentrated-liquidity
    """
...
def estimate_two_consecutive_positions_zfo_in_given_out(spread_factor: str, expected_token_in: str, expected_spread_rewards_growth_per_share_total: str):
    ...
    when swapping token zero for one (zfo).
     ...
     go test -timeout 30s -v -run TestKeeperTestSuite/TestCalcAndSwapInAmtGivenOut/fee_3 github.com/fury-labs/furya/v20/x/concentrated-liquidity
    """
...
def estimate_overlapping_price_range_ofz_test_in_given_out():
    ...
    when swapping token one for token zero (ofz).
     ...
     go test -timeout 30s -v -run TestKeeperTestSuite/TestCalcAndSwapInAmtGivenOut/fee_4 github.com/fury-labs/furya/v20/x/concentrated-liquidity
    """
...
def estimate_overlapping_price_range_zfo_test_in_given_out(tokein_in_initial: str, spread_factor: str, expected_token_in: str, expected_spread_rewards_growth_per_share_total: str):
    ...
    when swapping token zero for one (zfo) and not consuming full liquidity of the second position.
     ...
     go test -timeout 30s -v -run TestKeeperTestSuite/TestCalcAndSwapInAmtGivenOut/fee_5 github.com/fury-labs/furya/v20/x/concentrated-liquidity
    """
...
def estimate_consecutive_positions_gap_ofz_test_in_given_out():
    ...
    when swapping token one for zero (ofz).
     ...
     go test -timeout 30s -v -run TestKeeperTestSuite/TestCalcAndSwapInAmtGivenOut/fee_6 github.com/fury-labs/furya/v20/x/concentrated-liquidity
    """
...
def estimate_slippage_protection_zfo_test_in_given_out():
    ...
    when swapping token zero for one (zfo).
     ...
     go test -timeout 30s -v -run TestKeeperTestSuite/TestCalcAndSwapInAmtGivenOut/fee_7 github.com/fury-labs/furya/v20/x/concentrated-liquidity
    """
