...
The first step is to find an issue you want to fix. To identify issues we think are good for first-time contributors, we add the **good first issue** label. [You can see a list of issues to contribute here](https://github.com/fury-labs/furya/contribute).
...
If you have a feature request, please use the [feature-request repo](https://github.com/fury-labs/feature-requests). We also welcome you to [make an issue](https://github.com/fury-labs/furya/issues/new/choose) for anything of substance, or posting an issue if you want to work on it.
...
1. [Fork the repository](https://github.com/fury-labs/furya).
...
Copy the `templates` folder into your `.vscode` folder from our main repo [here](https://github.com/fury-labs/furya/tree/main/.vscode). This folder has our custom templates for generating tests that fit our testing standards as accurately as possible.
...
Additionally, there is an ability to disable certain components of the e2e suite. This can be done by setting the environment variables. See the [E2E test docs](https://github.com/fury-labs/furya/blob/main/tests/e2e/README.md)  or more details.
...
```sh
go get github.com/fury-labs/cosmos-sdk@{my commit hash}
```

You get something like:

```sh
go get: github.com/fury-labs/cosmos-sdk@v0.33.2 updating to
github.com/fury-labs/cosmos-sdk@v0.42.10-0.20210829064313-2c87644925da: parsing go.mod:
module declares its path as: github.com/cosmos/cosmos-sdk
but was required as: github.com/fury-labs/cosmos-sdk
```
...
- The GitHub release is created in our private repo via this [GitHub workflow](https://github.com/fury-labs/furya-ci/blob/main/.github/workflows/create-release.yaml). The workflow is manually triggered from the [furya-ci repository](https://github.com/fury-labs/furya-ci). The workflow uses the `make build-reproducible` command to create the `furyad` binaries using the default [Makefile](https://github.com/fury-labs/furya/blob/main/Makefile#L99).
...
- (Eventually) Make a PR that adds a version handler for the next upgrade
  - [Add v10 upgrade boilerplate #1649](https://github.com/fury-labs/furya/pull/1649/files)
...
following:
<https://github.com/fury-labs/furya/blob/8ef2f1845d9c7dd3f422d3f1953e36e5cf112e73/x/mint/types/errors.go#L8-L10>
...
[4]:https://github.com/fury-labs/cosmos-sdk/blob/5c9a51c277d067e0ec5cf48df30a85fae95bcd14/store/rootmulti/store.go#L430
[5]:https://github.com/fury-labs/cosmos-sdk/blob/5c9a51c277d067e0ec5cf48df30a85fae95bcd14/store/types/commit_info.go#L40
