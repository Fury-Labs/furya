...
// source: furya/txfees/v1beta1/feetoken.proto
...
// This marks the token as eligible for use as a tx fee asset in Furya.
...
func init() {
	proto.RegisterType((*FeeToken)(nil), "furya.txfees.v1beta1.FeeToken")
}

func init() {
	proto.RegisterFile("furya/txfees/v1beta1/feetoken.proto", fileDescriptor_c50689857adfcfe0)
}
