...
// source: furya/txfees/v1beta1/query.proto
...
func init() {
	proto.RegisterType((*QueryFeeTokensRequest)(nil), "furya.txfees.v1beta1.QueryFeeTokensRequest")
	proto.RegisterType((*QueryFeeTokensResponse)(nil), "furya.txfees.v1beta1.QueryFeeTokensResponse")
	proto.RegisterType((*QueryDenomSpotPriceRequest)(nil), "furya.txfees.v1beta1.QueryDenomSpotPriceRequest")
	proto.RegisterType((*QueryDenomSpotPriceResponse)(nil), "furya.txfees.v1beta1.QueryDenomSpotPriceResponse")
	proto.RegisterType((*QueryDenomPoolIdRequest)(nil), "furya.txfees.v1beta1.QueryDenomPoolIdRequest")
	proto.RegisterType((*QueryDenomPoolIdResponse)(nil), "furya.txfees.v1beta1.QueryDenomPoolIdResponse")
	proto.RegisterType((*QueryBaseDenomRequest)(nil), "furya.txfees.v1beta1.QueryBaseDenomRequest")
	proto.RegisterType((*QueryBaseDenomResponse)(nil), "furya.txfees.v1beta1.QueryBaseDenomResponse")
}

func init() {
	proto.RegisterFile("furya/txfees/v1beta1/query.proto", fileDescriptor_6cbc1b48c44dfdd6)
}
...
func (c *queryClient) FeeTokens(ctx context.Context, in *QueryFeeTokensRequest, opts ...grpc.CallOption) (*QueryFeeTokensResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/furya.txfees.v1beta1.Query/FeeTokens", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) DenomSpotPrice(ctx context.Context, in *QueryDenomSpotPriceRequest, opts ...grpc.CallOption) (*QueryDenomSpotPriceResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/furya.txfees.v1beta1.Query/DenomSpotPrice", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) DenomPoolId(ctx context.Context, in *QueryDenomPoolIdRequest, opts ...grpc.CallOption) (*QueryDenomPoolIdResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/furya.txfees.v1beta1.Query/DenomPoolId", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) BaseDenom(ctx context.Context, in *QueryBaseDenomRequest, opts ...grpc.CallOption) (*QueryBaseDenomResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/furya.txfees.v1beta1.Query/BaseDenom", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_FeeTokens_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/furya.txfees.v1beta1.Query/FeeTokens",
	}
...
func _Query_DenomSpotPrice_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/furya.txfees.v1beta1.Query/DenomSpotPrice",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_DenomPoolId_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/furya.txfees.v1beta1.Query/DenomPoolId",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_BaseDenom_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/furya.txfees.v1beta1.Query/BaseDenom",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "furya.txfees.v1beta1.Query",
	...
	Metadata: "furya/txfees/v1beta1/query.proto",
}
