...
const (
	...
	// FeeCollectorForStakingRewardsName the module account name for the alt fee collector account address (used for auto-swapping non-FURY tx fees).
	// These fees go to the staking rewards pool.
	FeeCollectorForStakingRewardsName = "non_native_fee_collector"

	// FeeCollectorForCommunityPoolName the module account name for the alt fee collector account address (used for auto-swapping non-FURY tx fees).
