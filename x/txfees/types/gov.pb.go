...
// source: furya/txfees/v1beta1/gov.proto
...
func init() {
	proto.RegisterType((*UpdateFeeTokenProposal)(nil), "furya.txfees.v1beta1.UpdateFeeTokenProposal")
}

func init() { proto.RegisterFile("furya/txfees/v1beta1/gov.proto", fileDescriptor_2c4a51bafc82863d) }
