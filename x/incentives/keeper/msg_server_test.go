...
func (s *KeeperTestSuite) TestCreateGroup_Fee() {
	tests := []struct {
	...
	}{
		{
			...
			accountBalanceToFund: sdk.NewCoins(sdk.NewCoin("ufury", osmomath.NewInt(100000000)), sdk.NewCoin(sdk.DefaultBondDenom, osmomath.NewInt(10000000))),
		...
		},
		{
			...
			accountBalanceToFund: sdk.NewCoins(sdk.NewCoin("ufury", osmomath.NewInt(100000000)), sdk.NewCoin(sdk.DefaultBondDenom, osmomath.NewInt(15000000))),
			groupFunds:           tenTokens,
			numEpochsPaidOver:    3,
		},
		{
		...
		},
		{
			...
			accountBalanceToFund: sdk.NewCoins(sdk.NewCoin("ufury", osmomath.NewInt(90000000)), sdk.NewCoin(sdk.DefaultBondDenom, osmomath.NewInt(10000000))),
			groupFunds:           tenTokens,
			expectErr:            true,
			numEpochsPaidOver:    3,
		},
		{
			...
			accountBalanceToFund: sdk.NewCoins(sdk.NewCoin("ufury", osmomath.NewInt(100000000)), sdk.NewCoin(sdk.DefaultBondDenom, osmomath.NewInt(9000000))),
			groupFunds:           tenTokens,
			expectErr:            true,
			numEpochsPaidOver:    3,
		},
