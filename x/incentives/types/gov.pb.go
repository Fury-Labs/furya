...
// source: furya/incentives/gov.proto
...
func init() {
	proto.RegisterType((*CreateGroupsProposal)(nil), "furya.incentives.CreateGroupsProposal")
}

func init() { proto.RegisterFile("furya/incentives/gov.proto", fileDescriptor_6ba11ff6685af82a) }
