...
// source: furya/incentives/genesis.proto
...
func init() {
	proto.RegisterType((*GenesisState)(nil), "furya.incentives.GenesisState")
}

func init() { proto.RegisterFile("furya/incentives/genesis.proto", fileDescriptor_a288ccc95d977d2d) }
