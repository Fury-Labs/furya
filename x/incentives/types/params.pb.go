...
// source: furya/incentives/params.proto
...
func init() {
	proto.RegisterType((*Params)(nil), "furya.incentives.Params")
}

func init() { proto.RegisterFile("furya/incentives/params.proto", fileDescriptor_1cc8b460d089f845) }
