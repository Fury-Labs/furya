...
func RegisterCodec(cdc *codec.LegacyAmino) {
	cdc.RegisterConcrete(&MsgCreateGauge{}, "furya/incentives/create-gauge", nil)
	cdc.RegisterConcrete(&MsgAddToGauge{}, "furya/incentives/add-to-gauge", nil)

	// gov proposals
	cdc.RegisterConcrete(&CreateGroupsProposal{}, "furya/create-groups-proposal", nil)
}
