...
// source: furya/incentives/group.proto
...
type Group struct {
	...
	SplittingPolicy   SplittingPolicy   `protobuf:"varint,3,opt,name=splitting_policy,json=splittingPolicy,proto3,enum=furya.incentives.SplittingPolicy" json:"splitting_policy,omitempty"`
}
...
func init() {
	proto.RegisterEnum("furya.incentives.SplittingPolicy", SplittingPolicy_name, SplittingPolicy_value)
	proto.RegisterType((*InternalGaugeInfo)(nil), "furya.incentives.InternalGaugeInfo")
	proto.RegisterType((*InternalGaugeRecord)(nil), "furya.incentives.InternalGaugeRecord")
	proto.RegisterType((*Group)(nil), "furya.incentives.Group")
	proto.RegisterType((*CreateGroup)(nil), "furya.incentives.CreateGroup")
	proto.RegisterType((*GroupsWithGauge)(nil), "furya.incentives.GroupsWithGauge")
}

func init() { proto.RegisterFile("furya/incentives/group.proto", fileDescriptor_90cab10cb3a674f3) }
