...
func init() {
	...
	proto.RegisterType((*WeightedAddress)(nil), "furya.mint.v1beta1.WeightedAddress")
...
func init() { proto.RegisterFile("furya/mint/v1beta1/mint.proto", fileDescriptor_ccb38f8335e0f45b) }
