...
func init() {
	...
	proto.RegisterType((*QueryEpochProvisionsRequest)(nil), "furya.mint.v1beta1.QueryEpochProvisionsRequest")
	proto.RegisterType((*QueryEpochProvisionsResponse)(nil), "furya.mint.v1beta1.QueryEpochProvisionsResponse")
}

func init() { proto.RegisterFile("furya/mint/v1beta1/query.proto", fileDescriptor_cd2f42111e753fbb) }
...
func (c *queryClient) EpochProvisions(ctx context.Context, in *QueryEpochProvisionsRequest, opts ...grpc.CallOption) (*QueryEpochProvisionsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/furya.mint.v1beta1.Query/EpochProvisions", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_EpochProvisions_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/furya.mint.v1beta1.Query/EpochProvisions",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
