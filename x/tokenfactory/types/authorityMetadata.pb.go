...
// source: furya/tokenfactory/v1beta1/authorityMetadata.proto
...
type DenomAuthorityMetadata struct {
	// Can be empty for no admin, or a valid furya address
...
func init() {
	proto.RegisterType((*DenomAuthorityMetadata)(nil), "furya.tokenfactory.v1beta1.DenomAuthorityMetadata")
}

func init() {
	proto.RegisterFile("furya/tokenfactory/v1beta1/authorityMetadata.proto", fileDescriptor_99435de88ae175f7)
}
