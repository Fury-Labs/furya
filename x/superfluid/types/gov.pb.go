...
// source: furya/superfluid/v1beta1/gov.proto
...
func init() {
	proto.RegisterType((*SetSuperfluidAssetsProposal)(nil), "furya.superfluid.v1beta1.SetSuperfluidAssetsProposal")
	proto.RegisterType((*RemoveSuperfluidAssetsProposal)(nil), "furya.superfluid.v1beta1.RemoveSuperfluidAssetsProposal")
	proto.RegisterType((*UpdateUnpoolWhiteListProposal)(nil), "furya.superfluid.v1beta1.UpdateUnpoolWhiteListProposal")
}

func init() {
	proto.RegisterFile("furya/superfluid/v1beta1/gov.proto", fileDescriptor_2e37d6a8d0e42294)
}
