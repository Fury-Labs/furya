...
// source: furya/superfluid/genesis.proto
...
type GenesisState struct {
	...
	FuryEquivalentMultipliers []FuryEquivalentMultiplierRecord `protobuf:"bytes,3,rep,name=fury_equivalent_multipliers,json=osmoEquivalentMultipliers,proto3" json:"fury_equivalent_multipliers"`
...
func init() {
	proto.RegisterType((*GenesisState)(nil), "furya.superfluid.GenesisState")
}

func init() { proto.RegisterFile("furya/superfluid/genesis.proto", fileDescriptor_d5256ebb7c83fff3) }
