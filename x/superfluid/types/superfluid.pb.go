...
// source: furya/superfluid/superfluid.proto
...
type SuperfluidAsset struct {
	...
	// share
	AssetType SuperfluidAssetType `protobuf:"varint,2,opt,name=asset_type,json=assetType,proto3,enum=furya.superfluid.SuperfluidAssetType" json:"asset_type,omitempty"`
}
...
func init() {
	...
	proto.RegisterType((*ConcentratedPoolUserPositionRecord)(nil), "furya.superfluid.ConcentratedPoolUserPositionRecord")
}

func init() {
	proto.RegisterFile("furya/superfluid/superfluid.proto", fileDescriptor_79d3c29d82dbb734)
}
