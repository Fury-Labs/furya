...
// source: furya/twap/v1beta1/twap_record.proto
...
func init() {
	proto.RegisterType((*TwapRecord)(nil), "furya.twap.v1beta1.TwapRecord")
}

func init() {
	proto.RegisterFile("furya/twap/v1beta1/twap_record.proto", fileDescriptor_dbf5c78678e601aa)
}
