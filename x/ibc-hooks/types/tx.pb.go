...
// source: furya/ibc-hooks/tx.proto
...
func init() {
	proto.RegisterType((*MsgEmitIBCAck)(nil), "furya.ibchooks.MsgEmitIBCAck")
	proto.RegisterType((*MsgEmitIBCAckResponse)(nil), "furya.ibchooks.MsgEmitIBCAckResponse")
}

func init() { proto.RegisterFile("furya/ibc-hooks/tx.proto", fileDescriptor_93268c51ed820a58) }
...
func (c *msgClient) EmitIBCAck(ctx context.Context, in *MsgEmitIBCAck, opts ...grpc.CallOption) (*MsgEmitIBCAckResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/furya.ibchooks.Msg/EmitIBCAck", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_EmitIBCAck_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/furya.ibchooks.Msg/EmitIBCAck",
	}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "furya.ibchooks.Msg",
	...
	Metadata: "furya/ibc-hooks/tx.proto",
}
