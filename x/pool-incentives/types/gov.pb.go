...
// source: furya/pool-incentives/v1beta1/gov.proto
...
func init() {
	proto.RegisterType((*ReplacePoolIncentivesProposal)(nil), "furya.poolincentives.v1beta1.ReplacePoolIncentivesProposal")
	proto.RegisterType((*UpdatePoolIncentivesProposal)(nil), "furya.poolincentives.v1beta1.UpdatePoolIncentivesProposal")
}

func init() {
	proto.RegisterFile("furya/pool-incentives/v1beta1/gov.proto", fileDescriptor_96caede426ba9516)
}
