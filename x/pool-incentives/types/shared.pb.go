...
// source: furya/pool-incentives/v1beta1/shared.proto
...
func init() {
	proto.RegisterType((*MigrationRecords)(nil), "furya.poolincentives.v1beta1.MigrationRecords")
	proto.RegisterType((*BalancerToConcentratedPoolLink)(nil), "furya.poolincentives.v1beta1.BalancerToConcentratedPoolLink")
}

func init() {
	proto.RegisterFile("furya/pool-incentives/v1beta1/shared.proto", fileDescriptor_f1449a8a614d7aea)
}
