...
// source: furya/pool-incentives/v1beta1/genesis.proto
...
func init() {
	proto.RegisterType((*GenesisState)(nil), "furya.poolincentives.v1beta1.GenesisState")
}

func init() {
	proto.RegisterFile("furya/pool-incentives/v1beta1/genesis.proto", fileDescriptor_cc1f078212600632)
}
