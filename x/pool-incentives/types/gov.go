...
func init() {
	...
	govtypes.RegisterProposalTypeCodec(&UpdatePoolIncentivesProposal{}, "furya/UpdatePoolIncentivesProposal")
	govtypes.RegisterProposalType(ProposalTypeReplacePoolIncentives)
	govtypes.RegisterProposalTypeCodec(&ReplacePoolIncentivesProposal{}, "furya/ReplacePoolIncentivesProposal")
}
