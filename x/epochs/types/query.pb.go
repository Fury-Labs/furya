...
// source: furya/epochs/query.proto
...
func init() {
	proto.RegisterType((*QueryEpochsInfoRequest)(nil), "furya.epochs.v1beta1.QueryEpochsInfoRequest")
	proto.RegisterType((*QueryEpochsInfoResponse)(nil), "furya.epochs.v1beta1.QueryEpochsInfoResponse")
	proto.RegisterType((*QueryCurrentEpochRequest)(nil), "furya.epochs.v1beta1.QueryCurrentEpochRequest")
	proto.RegisterType((*QueryCurrentEpochResponse)(nil), "furya.epochs.v1beta1.QueryCurrentEpochResponse")
}

func init() { proto.RegisterFile("furya/epochs/query.proto", fileDescriptor_574bd176519c765f) }
...
func (c *queryClient) EpochInfos(ctx context.Context, in *QueryEpochsInfoRequest, opts ...grpc.CallOption) (*QueryEpochsInfoResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/furya.epochs.v1beta1.Query/EpochInfos", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) CurrentEpoch(ctx context.Context, in *QueryCurrentEpochRequest, opts ...grpc.CallOption) (*QueryCurrentEpochResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/furya.epochs.v1beta1.Query/CurrentEpoch", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_EpochInfos_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/furya.epochs.v1beta1.Query/EpochInfos",
	}
...
func _Query_CurrentEpoch_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/furya.epochs.v1beta1.Query/CurrentEpoch",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "furya.epochs.v1beta1.Query",
	...
	Metadata: "furya/epochs/query.proto",
}
