...
// source: furya/lockup/genesis.proto
...
func init() {
	proto.RegisterType((*GenesisState)(nil), "furya.lockup.GenesisState")
}

func init() { proto.RegisterFile("furya/lockup/genesis.proto", fileDescriptor_648db7c6ebb608b0) }
