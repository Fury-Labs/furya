...
// source: furya/lockup/params.proto
...
func init() {
	proto.RegisterType((*Params)(nil), "furya.lockup.Params")
}

func init() { proto.RegisterFile("furya/lockup/params.proto", fileDescriptor_4595e58f5e17053c) }
