...
// source: furya/lockup/lock.proto
...
type QueryCondition struct {
	...
	LockQueryType LockQueryType `protobuf:"varint,1,opt,name=lock_query_type,json=lockQueryType,proto3,enum=furya.lockup.LockQueryType" json:"lock_query_type,omitempty"`
...
func init() {
	proto.RegisterEnum("furya.lockup.LockQueryType", LockQueryType_name, LockQueryType_value)
	proto.RegisterType((*PeriodLock)(nil), "furya.lockup.PeriodLock")
	proto.RegisterType((*QueryCondition)(nil), "furya.lockup.QueryCondition")
	proto.RegisterType((*SyntheticLock)(nil), "furya.lockup.SyntheticLock")
}

func init() { proto.RegisterFile("furya/lockup/lock.proto", fileDescriptor_7e9d7527a237b489) }
