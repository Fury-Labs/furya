...
// source: furya/poolmanager/v2/query.proto
...
type SpotPriceResponse struct {
	...
	SpotPrice github_com_furya_labs_furya_furymath.BigDec `protobuf:"bytes,1,opt,name=spot_price,json=spotPrice,proto3,customtype=github.com/osmosis-labs/osmosis/osmomath.BigDec" json:"spot_price" yaml:"spot_price"`
}
...
func init() {
	proto.RegisterType((*SpotPriceRequest)(nil), "furya.poolmanager.v2.SpotPriceRequest")
	proto.RegisterType((*SpotPriceResponse)(nil), "furya.poolmanager.v2.SpotPriceResponse")
}

func init() {
	proto.RegisterFile("furya/poolmanager/v2/query.proto", fileDescriptor_eb2850debe8fb398)
}
...
func (c *queryClient) SpotPriceV2(ctx context.Context, in *SpotPriceRequest, opts ...grpc.CallOption) (*SpotPriceResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/furya.poolmanager.v2.Query/SpotPriceV2", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_SpotPriceV2_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/furya.poolmanager.v2.Query/SpotPriceV2",
	}
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "furya.poolmanager.v2.Query",
	...
	Metadata: "furya/poolmanager/v2/query.proto",
}
