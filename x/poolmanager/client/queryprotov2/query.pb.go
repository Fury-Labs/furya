...
type SpotPriceResponse struct {
	...
	SpotPrice github_com_furya_labs_furya_osmomath.BigDec `protobuf:"bytes,1,opt,name=spot_price,json=spotPrice,proto3,customtype=github.com/furya-labs/furya/osmomath.BigDec" json:"spot_price" yaml:"spot_price"`
}
