...
// source: furya/poolmanager/v1beta1/gov.proto
...
func init() {
	proto.RegisterType((*DenomPairTakerFeeProposal)(nil), "furya.poolmanager.v1beta1.DenomPairTakerFeeProposal")
}

func init() {
	proto.RegisterFile("furya/poolmanager/v1beta1/gov.proto", fileDescriptor_c95b3c1cda2a8632)
}
