...
// source: furya/poolmanager/v1beta1/swap_route.proto
...
func init() {
	proto.RegisterType((*SwapAmountInRoute)(nil), "furya.poolmanager.v1beta1.SwapAmountInRoute")
	proto.RegisterType((*SwapAmountOutRoute)(nil), "furya.poolmanager.v1beta1.SwapAmountOutRoute")
	proto.RegisterType((*SwapAmountInSplitRoute)(nil), "furya.poolmanager.v1beta1.SwapAmountInSplitRoute")
	proto.RegisterType((*SwapAmountOutSplitRoute)(nil), "furya.poolmanager.v1beta1.SwapAmountOutSplitRoute")
}

func init() {
	proto.RegisterFile("furya/poolmanager/v1beta1/swap_route.proto", fileDescriptor_cddd97a9a05492a8)
}
