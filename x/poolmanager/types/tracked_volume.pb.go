...
// source: furya/poolmanager/v1beta1/tracked_volume.proto
...
func init() {
	proto.RegisterType((*TrackedVolume)(nil), "furya.poolmanager.v1beta1.TrackedVolume")
}

func init() {
	proto.RegisterFile("furya/poolmanager/v1beta1/tracked_volume.proto", fileDescriptor_0a2e3e91de3baf1a)
}
