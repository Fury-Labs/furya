...
// source: furya/poolmanager/v1beta1/genesis.proto
...
type TakerFeeParams struct {
	...
	//   - community_pool: the percent of the taker fee that gets sent to the
	//     community pool. Note: If the non-FURY asset is an authorized_quote_denom,
...
func init() {
	proto.RegisterType((*Params)(nil), "furya.poolmanager.v1beta1.Params")
	proto.RegisterType((*GenesisState)(nil), "furya.poolmanager.v1beta1.GenesisState")
	proto.RegisterType((*TakerFeeParams)(nil), "furya.poolmanager.v1beta1.TakerFeeParams")
	proto.RegisterType((*TakerFeeDistributionPercentage)(nil), "furya.poolmanager.v1beta1.TakerFeeDistributionPercentage")
}

func init() {
	proto.RegisterFile("furya/poolmanager/v1beta1/genesis.proto", fileDescriptor_aa099d9fbdf68b35)
}
