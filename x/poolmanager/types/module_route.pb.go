...
// source: furya/poolmanager/v1beta1/module_route.proto
...
type ModuleRoute struct {
	...
	PoolType PoolType `protobuf:"varint,1,opt,name=pool_type,json=poolType,proto3,enum=furya.poolmanager.v1beta1.PoolType" json:"pool_type,omitempty"`
...
func init() {
	proto.RegisterEnum("furya.poolmanager.v1beta1.PoolType", PoolType_name, PoolType_value)
	proto.RegisterType((*ModuleRoute)(nil), "furya.poolmanager.v1beta1.ModuleRoute")
}

func init() {
	proto.RegisterFile("furya/poolmanager/v1beta1/module_route.proto", fileDescriptor_96bfcc7b6d387cee)
}
