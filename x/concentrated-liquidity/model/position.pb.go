...
// source: furya/concentrated-liquidity/position.proto
...
import (
	...
	types2 "github.com/furya-labs/furya/v20/x/lockup/types"
	io "io"
	math "math"
	math_bits "math/bits"
	time "time"
...
func init() {
	proto.RegisterType((*Position)(nil), "furya.concentratedliquidity.v1beta1.Position")
	proto.RegisterType((*FullPositionBreakdown)(nil), "furya.concentratedliquidity.v1beta1.FullPositionBreakdown")
	proto.RegisterType((*PositionWithPeriodLock)(nil), "furya.concentratedliquidity.v1beta1.PositionWithPeriodLock")
}

func init() {
	proto.RegisterFile("furya/concentrated-liquidity/position.proto", fileDescriptor_ffdfd7b30d37d326)
}
