...
// source: furya/concentrated-liquidity/pool.proto
...
type Pool struct {
	...
	CurrentSqrtPrice     github_com_furya_labs_furya_furymath.BigDec `protobuf:"bytes,8,opt,name=current_sqrt_price,json=currentSqrtPrice,proto3,customtype=github.com/osmosis-labs/osmosis/osmomath.BigDec" json:"current_sqrt_price" yaml:"spot_price"`
...
func init() {
	proto.RegisterType((*Pool)(nil), "furya.concentratedliquidity.v1beta1.Pool")
}

func init() {
	proto.RegisterFile("furya/concentrated-liquidity/pool.proto", fileDescriptor_3526ea5373d96c9a)
}
