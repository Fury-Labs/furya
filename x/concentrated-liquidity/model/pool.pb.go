...
type Pool struct {
	...
	CurrentSqrtPrice     github_com_furya_labs_furya_osmomath.BigDec `protobuf:"bytes,8,opt,name=current_sqrt_price,json=currentSqrtPrice,proto3,customtype=github.com/fury-labs/furya/osmomath.BigDec" json:"current_sqrt_price" yaml:"spot_price"`
