...
// source: furya/concentrated-liquidity/tickInfo.proto
...
func init() {
	proto.RegisterType((*TickInfo)(nil), "furya.concentratedliquidity.v1beta1.TickInfo")
	proto.RegisterType((*UptimeTrackers)(nil), "furya.concentratedliquidity.v1beta1.UptimeTrackers")
	proto.RegisterType((*UptimeTracker)(nil), "furya.concentratedliquidity.v1beta1.UptimeTracker")
}

func init() {
	proto.RegisterFile("furya/concentrated-liquidity/tickInfo.proto", fileDescriptor_1ccb7e45032b943a)
}
