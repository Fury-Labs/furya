...
// source: furya/concentrated-liquidity/incentive_record.proto
...
func init() {
	proto.RegisterType((*IncentiveRecord)(nil), "furya.concentratedliquidity.v1beta1.IncentiveRecord")
	proto.RegisterType((*IncentiveRecordBody)(nil), "furya.concentratedliquidity.v1beta1.IncentiveRecordBody")
}

func init() {
	proto.RegisterFile("furya/concentrated-liquidity/incentive_record.proto", fileDescriptor_9d38bf94e42ee434)
}
