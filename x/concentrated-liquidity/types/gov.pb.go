...
// source: furya/concentrated-liquidity/gov.proto
...
func init() {
	proto.RegisterType((*CreateConcentratedLiquidityPoolsProposal)(nil), "furya.concentratedliquidity.v1beta1.CreateConcentratedLiquidityPoolsProposal")
	proto.RegisterType((*TickSpacingDecreaseProposal)(nil), "furya.concentratedliquidity.v1beta1.TickSpacingDecreaseProposal")
	proto.RegisterType((*PoolIdToTickSpacingRecord)(nil), "furya.concentratedliquidity.v1beta1.PoolIdToTickSpacingRecord")
	proto.RegisterType((*PoolRecord)(nil), "furya.concentratedliquidity.v1beta1.PoolRecord")
}

func init() {
	proto.RegisterFile("furya/concentrated-liquidity/gov.proto", fileDescriptor_e6d167276ceeedc2)
}
