...
// source: furya/concentrated-liquidity/params.proto
...
func init() {
	proto.RegisterType((*Params)(nil), "furya.concentratedliquidity.Params")
}

func init() {
	proto.RegisterFile("furya/concentrated-liquidity/params.proto", fileDescriptor_cd3784445b6f6ba7)
}
