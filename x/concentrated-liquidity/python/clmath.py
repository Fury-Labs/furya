...
def calc_amount_zero_delta(liquidity, sqrtPriceA, sqrtPriceB, roundUp):
    ...
    if roundUp:
        return round_fury_prec_up(round_fury_prec_up(round_fury_prec_up(product_num) / sqrtPriceA) / sqrtPriceB)

    return round_fury_prec_down(round_fury_prec_down(round_fury_prec_down(product_num) / sqrtPriceA)/ sqrtPriceB)
