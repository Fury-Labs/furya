...
// source: furya/cosmwasmpool/v1beta1/gov.proto
...
func init() {
	proto.RegisterType((*UploadCosmWasmPoolCodeAndWhiteListProposal)(nil), "furya.cosmwasmpool.v1beta1.UploadCosmWasmPoolCodeAndWhiteListProposal")
	proto.RegisterType((*MigratePoolContractsProposal)(nil), "furya.cosmwasmpool.v1beta1.MigratePoolContractsProposal")
}

func init() {
	proto.RegisterFile("furya/cosmwasmpool/v1beta1/gov.proto", fileDescriptor_c184a48c55bbcf5c)
}
