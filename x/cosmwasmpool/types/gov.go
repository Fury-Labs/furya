...
func init() {
	...
	govtypes.RegisterProposalTypeCodec(&UploadCosmWasmPoolCodeAndWhiteListProposal{}, "furya/UploadCosmWasmPoolCodeAndWhiteListProposal")
	govtypes.RegisterProposalType(ProposalTypeMigratePoolContractsProposal)
	govtypes.RegisterProposalTypeCodec(&MigratePoolContractsProposal{}, "furya/MigratePoolContractsProposal")
}
