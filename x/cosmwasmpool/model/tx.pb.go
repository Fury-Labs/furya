...
// source: furya/cosmwasmpool/v1beta1/model/tx.proto
...
func init() {
	proto.RegisterType((*MsgCreateCosmWasmPool)(nil), "furya.cosmwasmpool.v1beta1.MsgCreateCosmWasmPool")
	proto.RegisterType((*MsgCreateCosmWasmPoolResponse)(nil), "furya.cosmwasmpool.v1beta1.MsgCreateCosmWasmPoolResponse")
}

func init() {
	proto.RegisterFile("furya/cosmwasmpool/v1beta1/model/tx.proto", fileDescriptor_2ff1ac8555d314d1)
}
...
func (c *msgCreatorClient) CreateCosmWasmPool(ctx context.Context, in *MsgCreateCosmWasmPool, opts ...grpc.CallOption) (*MsgCreateCosmWasmPoolResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/furya.cosmwasmpool.v1beta1.MsgCreator/CreateCosmWasmPool", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _MsgCreator_CreateCosmWasmPool_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/furya.cosmwasmpool.v1beta1.MsgCreator/CreateCosmWasmPool",
	}
...
var _MsgCreator_serviceDesc = grpc.ServiceDesc{
	ServiceName: "furya.cosmwasmpool.v1beta1.MsgCreator",
	...
	Metadata: "furya/cosmwasmpool/v1beta1/model/tx.proto",
}
