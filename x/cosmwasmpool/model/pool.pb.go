...
// source: furya/cosmwasmpool/v1beta1/model/pool.proto
...
func init() {
	proto.RegisterType((*CosmWasmPool)(nil), "furya.cosmwasmpool.v1beta1.CosmWasmPool")
}

func init() {
	proto.RegisterFile("furya/cosmwasmpool/v1beta1/model/pool.proto", fileDescriptor_a0cb64564a744af1)
}
