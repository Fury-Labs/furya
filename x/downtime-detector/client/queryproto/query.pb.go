...
// source: furya/downtime-detector/v1beta1/query.proto
...
import (
	...
	types "github.com/furya-labs/furya/v20/x/downtime-detector/types"
...
type RecoveredSinceDowntimeOfLengthRequest struct {
	Downtime types.Downtime `protobuf:"varint,1,opt,name=downtime,proto3,enum=furya.downtimedetector.v1beta1.Downtime" json:"downtime,omitempty" yaml:"downtime"`
...
func init() {
	proto.RegisterType((*RecoveredSinceDowntimeOfLengthRequest)(nil), "furya.downtimedetector.v1beta1.RecoveredSinceDowntimeOfLengthRequest")
	proto.RegisterType((*RecoveredSinceDowntimeOfLengthResponse)(nil), "furya.downtimedetector.v1beta1.RecoveredSinceDowntimeOfLengthResponse")
}

func init() {
	proto.RegisterFile("furya/downtime-detector/v1beta1/query.proto", fileDescriptor_b748b3d07fa8b8cb)
}
...
func (c *queryClient) RecoveredSinceDowntimeOfLength(ctx context.Context, in *RecoveredSinceDowntimeOfLengthRequest, opts ...grpc.CallOption) (*RecoveredSinceDowntimeOfLengthResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/furya.downtimedetector.v1beta1.Query/RecoveredSinceDowntimeOfLength", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_RecoveredSinceDowntimeOfLength_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/furya.downtimedetector.v1beta1.Query/RecoveredSinceDowntimeOfLength",
	}
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "furya.downtimedetector.v1beta1.Query",
	...
	Metadata: "furya/downtime-detector/v1beta1/query.proto",
}
