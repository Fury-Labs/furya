...
// source: furya/downtime-detector/v1beta1/genesis.proto
...
type GenesisDowntimeEntry struct {
	Duration     Downtime  `protobuf:"varint,1,opt,name=duration,proto3,enum=furya.downtimedetector.v1beta1.Downtime" json:"duration,omitempty" yaml:"duration"`
...
func init() {
	proto.RegisterType((*GenesisDowntimeEntry)(nil), "furya.downtimedetector.v1beta1.GenesisDowntimeEntry")
	proto.RegisterType((*GenesisState)(nil), "furya.downtimedetector.v1beta1.GenesisState")
}

func init() {
	proto.RegisterFile("furya/downtime-detector/v1beta1/genesis.proto", fileDescriptor_4581e137a44782af)
}
