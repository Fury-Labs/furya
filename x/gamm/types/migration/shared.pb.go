...
// source: furya/gamm/v1beta1/shared.proto
...
func init() {
	proto.RegisterType((*MigrationRecords)(nil), "furya.gamm.v1beta1.MigrationRecords")
	proto.RegisterType((*BalancerToConcentratedPoolLink)(nil), "furya.gamm.v1beta1.BalancerToConcentratedPoolLink")
}

func init() { proto.RegisterFile("furya/gamm/v1beta1/shared.proto", fileDescriptor_ecfa270aa4b2c075) }
