	...
	testcases := map[string]testcase{
		...
		"even pool": {
			...
			poolLiquidity: sdk.NewCoins(
				...
				sdk.NewCoin("ufury", osmomath.NewInt(1_000_000_000)),
			),
		...
		"uneven pool (2:1)": {
			...
			poolLiquidity: sdk.NewCoins(
				...
				sdk.NewCoin("ufury", osmomath.NewInt(500_000)),
			),
			scalingFactors: []uint64{1, 1},
		},
		"uneven pool (1_000_000:1)": {
			...
			poolLiquidity: sdk.NewCoins(
				sdk.NewCoin("ion", osmomath.NewInt(1_000_000_000)),
				sdk.NewCoin("ufury", osmomath.NewInt(1_000)),
			),
			scalingFactors: []uint64{1, 1},
		},
		...
		"even multi-asset pool": {
			...
			poolLiquidity: sdk.NewCoins(
				sdk.NewCoin("ion", osmomath.NewInt(1_000_000)),
				sdk.NewCoin("ufury", osmomath.NewInt(1_000_000)),
