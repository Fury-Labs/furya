...
// source: furya/gamm/pool-models/stableswap/stableswap_pool.proto
...
func init() {
	proto.RegisterType((*PoolParams)(nil), "furya.gamm.poolmodels.stableswap.v1beta1.PoolParams")
	proto.RegisterType((*Pool)(nil), "furya.gamm.poolmodels.stableswap.v1beta1.Pool")
}

func init() {
	proto.RegisterFile("furya/gamm/pool-models/stableswap/stableswap_pool.proto", fileDescriptor_ae0f054436f9999a)
}
