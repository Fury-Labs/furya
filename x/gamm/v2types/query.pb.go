...
// source: furya/gamm/v2/query.proto
...
import (
	...
	_ "github.com/furya-labs/furya/v20/x/gamm/types"
...
func init() {
	proto.RegisterType((*QuerySpotPriceRequest)(nil), "furya.gamm.v2.QuerySpotPriceRequest")
	proto.RegisterType((*QuerySpotPriceResponse)(nil), "furya.gamm.v2.QuerySpotPriceResponse")
}

func init() { proto.RegisterFile("furya/gamm/v2/query.proto", fileDescriptor_49ff000e88fc374c) }
...
func (c *queryClient) SpotPrice(ctx context.Context, in *QuerySpotPriceRequest, opts ...grpc.CallOption) (*QuerySpotPriceResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/furya.gamm.v2.Query/SpotPrice", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_SpotPrice_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/furya.gamm.v2.Query/SpotPrice",
	}
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "furya.gamm.v2.Query",
	...
	Metadata: "furya/gamm/v2/query.proto",
}
