...
func (s *KeeperTestSuite) TestCalcJoinPoolNoSwapShares() {
	...
	testCases := []struct {
	...
	}{
		{
			...
			poolId,
			sdk.NewCoins(sdk.NewCoin("foo", osmomath.NewInt(5000000)), sdk.NewCoin("bar", osmomath.NewInt(5000000)), sdk.NewCoin("baz", osmomath.NewInt(5000000)), sdk.NewCoin("ufury", osmomath.NewInt(5000000))),
			nil,
		},
		{
			"valid even multi asset join test case",
			poolId,
			sdk.NewCoins(sdk.NewCoin("foo", osmomath.NewInt(500000)), sdk.NewCoin("bar", osmomath.NewInt(1000000)), sdk.NewCoin("baz", osmomath.NewInt(1500000)), sdk.NewCoin("ufury", osmomath.NewInt(2000000))),
			nil,
		},
		{
			"invalid single asset join test case",
			poolId,
			sdk.NewCoins(sdk.NewCoin("ufury", osmomath.NewInt(1000000))),
		...
		},
		{
			...
			poolId,
			sdk.NewCoins(sdk.NewCoin("ufury", osmomath.NewInt(10000)), sdk.NewCoin("bar", osmomath.NewInt(10000))),
			errors.New("no-swap joins require LP'ing with all assets in pool"),
		},
	}
...
func (s *KeeperTestSuite) TestQueryTotalPoolLiquidity() {
	...
	s.Require().NoError(err)
	expectedCoins := sdk.NewCoins(sdk.NewCoin("foo", osmomath.NewInt(5000000)), sdk.NewCoin("bar", osmomath.NewInt(5000000)), sdk.NewCoin("baz", osmomath.NewInt(5000000)), sdk.NewCoin("ufury", osmomath.NewInt(5000000)))
