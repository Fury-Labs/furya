...
func (s *KeeperTestSuite) SetupTest() {
	...
	s.balances = sdk.NewCoins(
		sdk.NewCoin(types.FuryaDenomination, osmomath.NewInt(9000000000000000000)),
...
func (s *KeeperTestSuite) setUpPools() {
	...
	s.pools = []Pool{
		...
		{ // Pool 6
			PoolAssets: []balancer.PoolAsset{
				{
					Token:  sdk.NewCoin(types.FuryaDenomination, osmomath.NewInt(1000)),
					Weight: osmomath.NewInt(1),
				},
				{
					Token:  sdk.NewCoin("Atom", osmomath.NewInt(1000)),
		...
		{ // Pool 22
			PoolAssets: []balancer.PoolAsset{
				...
				{
					Token:  sdk.NewCoin(types.FuryaDenomination, osmomath.NewInt(191801648570)),
					Weight: osmomath.NewInt(1),
				},
			},
		...
		{ // Pool 24
			PoolAssets: []balancer.PoolAsset{
				...
				{
					Token:  sdk.NewCoin(types.FuryaDenomination, osmomath.NewInt(13901565323)),
					Weight: osmomath.NewInt(1),
				},
			},
			SpreadFactor: osmomath.NewDecWithPrec(2, 3),
		...
		{ // Pool 25
			PoolAssets: []balancer.PoolAsset{
				...
				{
					Token:  sdk.NewCoin(types.FuryaDenomination, osmomath.NewInt(139015653231902)),
					Weight: osmomath.NewInt(1),
				},
			},
			SpreadFactor: osmomath.NewDecWithPrec(2, 3),
		...
		{ // Pool 26
			PoolAssets: []balancer.PoolAsset{
				...
				{
					Token:  sdk.NewCoin(types.FuryaDenomination, osmomath.NewInt(171274446980)),
					Weight: osmomath.NewInt(50),
				},
			},
			SpreadFactor: osmomath.NewDecWithPrec(2, 3),
		...
		{ // Pool 27
			PoolAssets: []balancer.PoolAsset{
				...
				{
					Token:  sdk.NewCoin(types.FuryaDenomination, osmomath.NewInt(13466662920841)),
					Weight: osmomath.NewInt(50),
				},
			},
			SpreadFactor: osmomath.NewDecWithPrec(2, 3),
		...
		{ // Pool 29
			PoolAssets: []balancer.PoolAsset{
				{
					Token:  sdk.NewCoin("ufury", osmomath.NewInt(1000000000)),
					Weight: osmomath.NewInt(1),
				},
				{
		...
		{ // Pool 35
			PoolAssets: []balancer.PoolAsset{
				...
				{
					Token:  sdk.NewCoin(types.FuryaDenomination, osmomath.NewInt(1694086377216)),
					Weight: osmomath.NewInt(1),
				},
			},
			SpreadFactor: osmomath.NewDecWithPrec(2, 3),
		...
		{ // Pool 36
			PoolAssets: []balancer.PoolAsset{
				{
					Token:  sdk.NewCoin(types.FuryaDenomination, osmomath.NewInt(2774812791932)),
					Weight: osmomath.NewInt(1),
				},
				{
		...
		{ // Pool 38
			PoolAssets: []balancer.PoolAsset{
				{
					Token:  sdk.NewCoin(types.FuryaDenomination, osmomath.NewInt(6111815027)),
					Weight: osmomath.NewInt(1),
				},
				{
		...
		{ // Pool 39
			PoolAssets: []balancer.PoolAsset{
				...
				{
					Token:  sdk.NewCoin(types.FuryaDenomination, osmomath.NewInt(17000185817963)),
					Weight: osmomath.NewInt(1),
				},
			},
			SpreadFactor: osmomath.NewDecWithPrec(2, 3),
	...
	s.stableSwapPools = []StableSwapPool{
		...
		{ // Pool 47 - Used for epoch_hook UpdateHighestLiquidityPool testing
			initialLiquidity: sdk.NewCoins(
				sdk.NewCoin("epochOne", osmomath.NewInt(1000)),
				sdk.NewCoin("ufury", osmomath.NewInt(2000)),
			),
			poolParams: stableswap.PoolParams{
				SwapFee: osmomath.NewDecWithPrec(1, 4),
				ExitFee: osmomath.NewDecWithPrec(0, 2),
		...
		{ // Pool 49 - Used for CL testing
			initialLiquidity: sdk.NewCoins(
				sdk.NewCoin("ufury", osmomath.NewInt(10_000_000_000_000)),
	...
	s.createGAMMPool(
		[]balancer.PoolAsset{
			...
			{
				Token:  sdk.NewCoin(types.FuryaDenomination, osmomath.NewInt(10000)),
				Weight: osmomath.NewInt(1),
			},
		},
	...
	s.createGAMMPool(
		[]balancer.PoolAsset{
			...
			{
				Token:  sdk.NewCoin(types.FuryaDenomination, osmomath.NewInt(1000000000)),
				Weight: osmomath.NewInt(1),
			},
		},
		osmomath.NewDecWithPrec(2, 3),
	...
	// Pool 58
	// Create the CL pool
	clPool := s.PrepareCustomConcentratedPool(s.TestAccs[0], "epochTwo", "ufury", apptesting.DefaultTickSpacing, osmomath.ZeroDec())
	fundCoins := sdk.NewCoins(sdk.NewCoin("epochTwo", osmomath.NewInt(10_000_000_000_000)), sdk.NewCoin("ufury", osmomath.NewInt(10_000_000_000_000)))
	...
	// Create the CL pool
	clPool = s.PrepareCustomConcentratedPool(s.TestAccs[0], "epochTwo", "ufury", apptesting.DefaultTickSpacing, osmomath.ZeroDec())
	fundCoins = sdk.NewCoins(sdk.NewCoin("epochTwo", osmomath.NewInt(2_000_000_000)), sdk.NewCoin("ufury", osmomath.NewInt(1_000_000_000)))
	s.FundAcc(s.TestAccs[0], fundCoins)
	s.CreateFullRangePosition(clPool, fundCoins)
...
func (s *KeeperTestSuite) CreateCLPoolAndArbRouteWith_28000_Ticks() {
	// Create the CL pool
	clPool := s.PrepareCustomConcentratedPool(s.TestAccs[2], "ibc/0CD3A0285E1341859B5E86B6AB7682F023D03E97607CCC1DC95706411D866DF7", "ufury", 100, osmomath.NewDecWithPrec(2, 3))
	fundCoins := sdk.NewCoins(sdk.NewCoin("ufury", osmomath.NewInt(1000000000000000000)), sdk.NewCoin("ibc/0CD3A0285E1341859B5E86B6AB7682F023D03E97607CCC1DC95706411D866DF7", osmomath.NewInt(1000000000000000000)))
	s.FundAcc(s.TestAccs[2], fundCoins)

	// Create 28000 ticks in the CL pool, 14000 on each side
	tokensProvided := sdk.NewCoins(sdk.NewCoin("ufury", osmomath.NewInt(100000)), sdk.NewCoin("ibc/0CD3A0285E1341859B5E86B6AB7682F023D03E97607CCC1DC95706411D866DF7", osmomath.NewInt(100000)))
...
func (s *KeeperTestSuite) setUpTokenPairRoutes() {
	...
	fourPool1 := types.NewTrade(35, "test/1", types.FuryaDenomination)
	fourPool2 := types.NewTrade(36, types.FuryaDenomination, "test/2")
	fourPool3 := types.NewTrade(0, "test/2", "Atom")

	// Two-Pool Route
	twoPool0 := types.NewTrade(0, "ibc/0CD3A0285E1341859B5E86B6AB7682F023D03E97607CCC1DC95706411D866DF7", types.FuryaDenomination)
	twoPool1 := types.NewTrade(39, types.FuryaDenomination, "ibc/0CD3A0285E1341859B5E86B6AB7682F023D03E97607CCC1DC95706411D866DF7")

	// Doomsday Route - Stableswap
	doomsdayStable0 := types.NewTrade(29, types.FuryaDenomination, "usdc")
	doomsdayStable1 := types.NewTrade(0, "usdc", "busd")
	doomsdayStable2 := types.NewTrade(30, "busd", types.FuryaDenomination)
