		...
		},
		{
			...
			param: param{
				...
				executeSwap: func() {
					...
					_, err := s.App.PoolManagerKeeper.RouteExactAmountIn(s.Ctx, s.TestAccs[0], route, sdk.NewCoin("ufury", osmomath.NewInt(10)), osmomath.NewInt(1))
					s.Require().NoError(err)
				},
			},
			expectPass: true,
...
func (s *KeeperTestSuite) TestPoolCreation() {
			...
			param: param{
				...
				executePoolCreation: func() uint64 {
					...
					balancerPoolId := s.createGAMMPool([]balancer.PoolAsset{
						...
						{
							Token:  sdk.NewCoin("ufury", osmomath.NewInt(1)),
							Weight: osmomath.NewInt(1),
						},
					},
	...
	for _, tc := range tests {
		s.Run(tc.name, func() {
			...
			setPoolId, err := s.App.ProtoRevKeeper.GetPoolForDenomPair(s.Ctx, types.FuryaDenomination, tc.param.matchDenom)
...
func (s *KeeperTestSuite) TestGetComparablePoolLiquidity() {
	...
	tests := []struct {
	...
	}{
		{
			...
			param: param{
				executePoolCreation: func() uint64 {
					return s.PrepareBalancerPoolWithCoins(sdk.NewCoin("ufury", osmomath.NewInt(10)), sdk.NewCoin("juno", osmomath.NewInt(10)))
				},
			...
			param: param{
				executePoolCreation: func() uint64 {
					return s.PrepareBalancerPoolWithCoins(
						sdk.NewCoin("ufury", osmomath.Int(osmomath.NewUintFromString("999999999999999999999999999999999999999"))),
	...
	}{
		{
			...
			param: param{
				...
				prepareStateAndGetPoolIdToCompare: func() (uint64, uint64) {
					...
					poolId := s.PrepareBalancerPoolWithCoins(sdk.NewCoin("ufury", osmomath.NewInt(10)), sdk.NewCoin("juno", osmomath.NewInt(10)))
		...
		},
		{
			...
			param: param{
				...
				prepareStateAndGetPoolIdToCompare: func() (uint64, uint64) {
					...
					preparedPoolId := s.PrepareBalancerPoolWithCoins(sdk.NewCoin("ufury", osmomath.NewInt(10)), sdk.NewCoin("stake", osmomath.NewInt(10)))
		...
		},
		{
			...
			param: param{
				...
				prepareStateAndGetPoolIdToCompare: func() (uint64, uint64) {
					...
					balancerPoolId := s.PrepareBalancerPoolWithCoins(sdk.NewCoin("ufury", osmomath.NewInt(2000000000000000000)), sdk.NewCoin("stake", osmomath.NewInt(1000000000000000000)))
					storedPoolId, err := s.App.ProtoRevKeeper.GetPoolForDenomPair(s.Ctx, "ufury", "stake")
					s.Require().NoError(err)
		...
		},
		{
			...
			param: param{
				...
				prepareStateAndGetPoolIdToCompare: func() (uint64, uint64) {
					...
					balancerPoolId := s.PrepareBalancerPoolWithCoins(sdk.NewCoin("ufury", osmomath.NewInt(500000000000000000)), sdk.NewCoin("stake", osmomath.NewInt(1000000000000000000)))
		...
		},
		{
			...
			param: param{
				...
				prepareStateAndGetPoolIdToCompare: func() (uint64, uint64) {
					...
					poolId := s.PrepareBalancerPoolWithCoins(sdk.NewCoin("ufury", osmomath.NewInt(10)), sdk.NewCoin("stake", osmomath.NewInt(10)))
