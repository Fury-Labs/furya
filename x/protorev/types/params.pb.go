...
// source: furya/protorev/v1beta1/params.proto
...
func init() {
	proto.RegisterType((*Params)(nil), "furya.protorev.v1beta1.Params")
}

func init() {
	proto.RegisterFile("furya/protorev/v1beta1/params.proto", fileDescriptor_72168e5a5a65ae7e)
}
