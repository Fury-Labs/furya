...
// source: furya/protorev/v1beta1/gov.proto
...
func init() {
	proto.RegisterType((*SetProtoRevEnabledProposal)(nil), "furya.protorev.v1beta1.SetProtoRevEnabledProposal")
	proto.RegisterType((*SetProtoRevAdminAccountProposal)(nil), "furya.protorev.v1beta1.SetProtoRevAdminAccountProposal")
}

func init() {
	proto.RegisterFile("furya/protorev/v1beta1/gov.proto", fileDescriptor_e1f85ff7f3eaf8bb)
}
