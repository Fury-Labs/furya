...
func (s *KeeperTestSuite) TestUndelegateFromValSetErrorCase() {
	...
	coinToStake := sdk.NewCoin(sdk.DefaultBondDenom, sdk.NewInt(10_000_000))   // delegate 10osmo using Valset now and 10 fury using regular staking delegate
	...
	s.FundAcc(delegator, sdk.Coins{sdk.NewInt64Coin(sdk.DefaultBondDenom, 100_000_000)}) // 100 fury
...
func (s *KeeperTestSuite) TestUndelegateFromValSetErrorCase1() {
	...
	coinToStake := sdk.NewCoin(sdk.DefaultBondDenom, sdk.NewInt(100_000_000))   // delegate 100osmo using Valset now and 10 fury using regular staking delegate
	coinToUnStake := sdk.NewCoin(sdk.DefaultBondDenom, sdk.NewInt(200_000_000)) // undelegate 20osmo

	s.FundAcc(delegator, sdk.Coins{sdk.NewInt64Coin(sdk.DefaultBondDenom, 300_000_000)}) // 100 fury
