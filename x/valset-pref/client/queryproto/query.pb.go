...
// source: furya/valset-pref/v1beta1/query.proto
...
import (
	...
	types "github.com/fury-labs/furya/v20/x/valset-pref/types"
...
func init() {
	proto.RegisterType((*UserValidatorPreferencesRequest)(nil), "furya.valsetpref.v1beta1.UserValidatorPreferencesRequest")
	proto.RegisterType((*UserValidatorPreferencesResponse)(nil), "furya.valsetpref.v1beta1.UserValidatorPreferencesResponse")
}

func init() {
	proto.RegisterFile("furya/valset-pref/v1beta1/query.proto", fileDescriptor_9ffbeb4123fe56ae)
}
...
func (c *queryClient) UserValidatorPreferences(ctx context.Context, in *UserValidatorPreferencesRequest, opts ...grpc.CallOption) (*UserValidatorPreferencesResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/furya.valsetpref.v1beta1.Query/UserValidatorPreferences", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_UserValidatorPreferences_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/furya.valsetpref.v1beta1.Query/UserValidatorPreferences",
	}
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "furya.valsetpref.v1beta1.Query",
	...
	Metadata: "furya/valset-pref/v1beta1/query.proto",
}
