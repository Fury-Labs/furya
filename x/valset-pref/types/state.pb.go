...
// source: furya/valset-pref/v1beta1/state.proto
...
func init() {
	proto.RegisterType((*ValidatorPreference)(nil), "furya.valsetpref.v1beta1.ValidatorPreference")
	proto.RegisterType((*ValidatorSetPreferences)(nil), "furya.valsetpref.v1beta1.ValidatorSetPreferences")
}

func init() {
	proto.RegisterFile("furya/valset-pref/v1beta1/state.proto", fileDescriptor_d3010474a5b89fce)
}
