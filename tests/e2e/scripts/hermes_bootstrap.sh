...
# import keys
hermes keys add --chain ${OSMO_B_E2E_CHAIN_ID} --key-name "val01-furya-b" --mnemonic-file /root/.hermes/OSMO_B_MNEMONIC.txt
hermes keys add --chain ${OSMO_A_E2E_CHAIN_ID} --key-name "val01-furya-a" --mnemonic-file /root/.hermes/OSMO_A_MNEMONIC.txt
