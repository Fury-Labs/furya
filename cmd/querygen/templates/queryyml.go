...
type QueryYml struct {
	...
	// Path to client folder e.g. "github.com/fury-labs/furya/v20/x/twap/client"
...
type Keeper struct {
	// e.g. github.com/fury-labs/furya/v20/x/twap
...
// input is of form github.com/fury-labs/furya/vXX/{PATH}
// returns PATH
