...
import (
	...
	clqueryproto "github.com/fury-labs/furya/v20/x/concentrated-liquidity/client/queryproto"
...
func TestAttachFieldsToUse(t *testing.T) {
	tests := map[string]struct {
		...
		"ignore_owner/TxCliDesc/attach_2_args": {
			...
			expectedUse: "lock-tokens [duration] [coins]", // in furya, this command takes duration from a flag, but here it is just for testing purposes
		},
