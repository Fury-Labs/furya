...
// source: furya/accum/v1beta1/accum.proto
...
func init() {
	proto.RegisterType((*AccumulatorContent)(nil), "furya.accum.v1beta1.AccumulatorContent")
	proto.RegisterType((*Options)(nil), "furya.accum.v1beta1.Options")
	proto.RegisterType((*Record)(nil), "furya.accum.v1beta1.Record")
}

func init() { proto.RegisterFile("furya/accum/v1beta1/accum.proto", fileDescriptor_4866f7c74a169dc2) }
